...
#set wd to where you download the Fiber_photometry-main zip file 
setwd("/Users/adamnelson/Downloads/Fiber_photometry-main")
maindir = paste(getwd(), sep="")
#Data directory 
datadir = paste(maindir, "/datafiles/", sep="")
#Plot directory 
# Create a directory to store plots (if it doesnt already exist)
dir.create(paste0(datadir, "plots"), showWarnings = TRUE)
